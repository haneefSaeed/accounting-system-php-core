...
$inventory = new AllPageContent();
$inventory->head("Purchase Orders | " . COMPANY_NAME);
$inventory_func = new invTransOperations();

$inventory->startSession("login.php");
    ...
    ?>
      ...
      <section class="forms">
        <div class="container-fluid">
          <!-- Page Header-->
          <header>
            <h1 class="h1 display">Inventory            </h1>
          </header>
                <div class="row">
                ...
                <div class="col-lg-12 ">
                  <div class="card">
                      <div class="card-body float-right ">
                          <?php
                          //$inventory_func->fetchProductsCategory();
                          ?>
                          <form class="form-inline float-right">


                                  <a href="View_all_po.php"  class="mr-3 btn btn-info"><i class="fa fa-bar-chart"></i> View Pruchase Orders</a>
                                  <a href="closed_po.php"  class="mr-3 btn btn-info"><i class="fa fa-bar-chart"></i> View Sales Orders</a>
                    ...
                    <div class="col-lg-12">
              <?php
                //$inventory_func->ProductOperationResults();
              ?>
                    </div>
                          ...
                          <div class="table-responsive">
                              <table class="table table-striped table-hover table-bordered PagedTable" id="PagedTable">
                                  ...
                                  <?php
                                      ...
                                      $inventory_func->FetchInventoryItems();
...
//$inventory_func->UpdateShipper(22);
    }
    //$inventory_func->UpdateShipper(25);
