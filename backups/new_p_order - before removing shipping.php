                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <table border="0" cellpadding="5">
                                    <tr>
                                        <td>
                                            <label class="float-left">Shipping Fee <?php echo " (" . $purchse_order->currency() . ")"; ?></label>
                                        </td>
                                        <td><label class="float-left">Shipment Date: </label></td>
                                    </tr>
                                    <tr>
                                        <td>
                            ...
                            <div class="form-group">
                                ...
                                <select class=" form-control col-lg-5" name="po_pay_method">
                            ...
                            <div class="form-group">
                                <label>Notes&nbsp;</label>
                                <textarea name="po_notes" class="form-control col-lg-12"></textarea>
