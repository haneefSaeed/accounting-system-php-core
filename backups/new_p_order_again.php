        ...
        <div class="col-lg-12 ">
            <div class="card">
                ...
                <div class="card-body float-right ">
                    <form class="form-inline float-right" id="purchase_order_form" name="purchase_order_form">
                        <button type="button" name="po_place_order" id="place_order" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Place Order</button> &nbsp;
                </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body  text-center align-content-center">
                    ...
                    <div class="form-group">
                        <table id="dynamic_field" class="table table-hover " cellpadding="3">
                            <tr>
                                <th>Product Name</th>
                                <th>Quantity</th>
